...
def fetch() -> list[dict]:
    """Fetch items from comfyui_nodes. See docs/AGENTS.md for return format."""
    # TODO: Implement — consult docs/SOURCE_EXPLORATION.md for this source
    logger.warning("comfyui_nodes fetcher not implemented yet")
    return []
