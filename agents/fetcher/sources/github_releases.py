"""
Source fetcher: github_releases
...
def fetch() -> list[dict]:
    """Fetch items from github_releases. See docs/AGENTS.md for return format."""
    # TODO: Implement — consult docs/SOURCE_EXPLORATION.md for this source
    logger.warning("github_releases fetcher not implemented yet")
    return []
